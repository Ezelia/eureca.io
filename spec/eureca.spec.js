...
var Eureca = require('../dist/EurecaServer');
...
describe("Server side", function () {
    it("should detect client connection", function (done) {
        ...
        eurecaServer.onConnect(function (socket) {
            ...
            tests.pop();
            console.log('conn Id = ', socket.id);
            expect(socket.id).not.toBe(undefined);
            client.disconnect();
            done();
        });
...
describe("Client -> Server ", function () {
    ...
    it("should call remote function", function (done) {
        ...
        whenClientReady(function () {
            clientProxy.hello().then(function (r) {
                flag = true;
                value = r;
                console.log('R = ', r);
    ...
    it("should call remote function and get back result", function (done) {
        ...
        value = '';
        whenClientReady(function () {
            clientProxy.foo().then(function (r) {
                flag = true;
                value = r;
                console.log('R = ', r);

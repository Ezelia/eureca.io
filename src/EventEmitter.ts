...
export class EventEmitter {
     ...
     * @public
     */
    public emit(event, a1?, a2?, a3?, a4?, a5?) {
        var evt = prefix ? prefix + event : event;
     ...
     * @public
     */
    public removeListener(event, fn, context, once) {
        var evt = prefix ? prefix + event : event;
...
//
(<any>EventEmitter).prototype.off = EventEmitter.prototype.removeListener;
(<any>EventEmitter).prototype.addListener = EventEmitter.prototype.on;

//
// Expose the prefix.
//
(<any>EventEmitter).prefixed = prefix;
